...
## 13.8.0.0
* Certified with GoogleAdManager SDK 13.8.0.

## 13.7.0.0
* Certified with GoogleAdManager SDK 13.7.0.

## 13.6.0.0
* Certified with GoogleAdManager SDK 13.6.0.

## 13.5.0.0
* Certified with GoogleAdManager SDK 13.5.0.
...
## 12.13.0.0
* Certified with GoogleAdManager SDK 12.13.0.
...
## 12.5.0.0
* Certified with GoogleAdManager SDK 12.5.0.

## 12.4.0.1
* Removed requirement of the title asset for native banners and MRECs.

## 12.4.0.0
* Certified with GoogleAdManager SDK 12.4.0.

## 12.3.0.0
* Certified with GoogleAdManager SDK 12.3.0.
* Removed deprecated code paths based on the minimum supported AppLovin MAX SDK version 13.0.0.

## 12.2.0.0
* Certified with GoogleAdManager SDK 12.2.0.
* Updated minimum Xcode requirement to 16.0 to match GoogleAdManager SDK.

## 12.1.0.0
* Certified with GoogleAdManager SDK 12.1.0.
...
## 11.13.0.0
* Certified with GoogleAdManager SDK 11.13.0.

## 11.12.0.0
* Certified with GoogleAdManager SDK 11.12.0.
